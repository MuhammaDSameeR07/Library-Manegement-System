...
namespace LibraryMSMVC.Controllers
{
    public class AdminController : Controller
    {
        ...
        public ActionResult Login(tblAdmin admin)
        {
            ...
            var adm = context.tblAdmins.SingleOrDefault(a => a.AdminEmail == admin.AdminEmail && a.AdminPass == admin.AdminPass); //.tblAdmins.SingleOrDefault(a => a.AdminEmail == admin.AdminEmail && a.AdminPass == admin.AdminPass);
